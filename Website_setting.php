...
<!--Sidenav-->
      ...
      <div  style="color: rgb(255, 255, 255); border-radius: 6px; text-shadow: 2px 3px 3px rgb(253, 253, 255); text-align: center; padding: 5px; background-color:rgb(25, 25, 51)"><h1> Website Setting</h1></div><hr>
       ...
       <form action="">
        <div class="container">
          ...
          <input type="text" placeholder="Online Fire reporting Management System" name="name" required>
      
          <label for="logo"><b>Upload Logo</b></label>
          <input type="file" placeholder="Upload Logo" name="logo" required>
